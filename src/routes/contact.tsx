        ...
        <div className="lg:col-span-6">
          ...
          <dl className="mt-12 grid sm:grid-cols-2 gap-8">
            ...
            <div className="sm:col-span-2">
              <dt className="flex items-center gap-2 eyebrow text-olive mb-4"><Clock size={14} /> Openingstijden</dt>
              <dd>
                ...
                <p className="mt-4 text-xs text-walnut/60 uppercase tracking-widest">Trimsalon op afspraak</p>
              </dd>
            </div>
            <div>
